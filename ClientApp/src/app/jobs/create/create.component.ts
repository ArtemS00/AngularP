...
export class JobCreateComponent {
    ...
    experienceTypeForm: FormControl = new FormControl('', [Validators.required]);
    ...
    constructor() {
        this.salaryMinForm.setValidators(this.validateMaxMinControls(this.salaryMinForm, this.salaryMaxForm));
        this.salaryMaxForm.setValidators(this.validateMaxMinControls(this.salaryMinForm, this.salaryMaxForm));
        ...
        this.form = new FormGroup({
            ...
            ["experienceType"]: this.experienceTypeForm,
